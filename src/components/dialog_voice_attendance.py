...
def voice_attendance_dialog(selected_subject_id):
    st.write('Record audio of students sayind i am present.Then AI will Recognize')
    audio_data=None

    audio_data=st.audio_input('Record students audio ')
    if st.button("Analayze Audio",width='stretch',type='primary'):
        with st.spinner('Processing Audio Data'):
            ...
            if not candidate_dict:
                st.error("No enrolled students hae voice profiles registered")
                return
